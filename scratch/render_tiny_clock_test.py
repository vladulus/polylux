r"""Test the 3x5 hardcoded font with "12:34" in rotations 90 and 270."""
...
def main() -> int:
    with AniMeMatrix.open() as m:
        for rotation in (90, 270):
            print(f"rotation = {rotation}° with 3x5 font, '12:34'")
            f = Frame()
            f.draw_tiny_text("12:34", color=(0xFF, 0xFF, 0xFF), rotation=rotation)
            hold(m, f, 8)
        m.clear()
        m.flush()
    print("done.")
